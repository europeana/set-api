...
3. Update Github Workflow to run decrypt script (NOTE: secrets.SET_API_PROPS_ENCODING_PASS is the name of the secret in Github secrets see Settings-> Secrets and Variables -> Actions -> Secrets)
 ...
 steps:
      ...
      - name: Decrypt configuration properties
        ...
        env:
          SECRET_PROPS_PASSPHRASE: ${{ secrets.SET_API_PROPS_ENCODING_PASS }}
	   .....  
