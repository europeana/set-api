...
public class PersistentUserSetServiceTest extends UserSetTestDataBuilder {
    ...
    private static final String CREATOR_ID = "test-creator-id";
...
//		userSetDao.getCollection().drop();	
    ...
    public void Test_remove() {
     ...
     UserSet deletedUserSet = userSetService.getByIdentifier(((PersistentUserSetImpl) storedUserSet).getIdentifier());
