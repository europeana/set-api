...
public class SearchApiClientException extends Exception {
    ...
    public static final String MESSAGE_CANNOT_ACCESS_API     = "Cannot access search API to retrieve items of user set.";
    public static final String MESSAGE_CANNOT_PARSE_RESPONSE = "Cannot parse search API response.";
    public static final String MESSAGE_CANNOT_RETRIEVE_ITEMS = "Cannot retrieve items of user set.";
