...
public class SearchApiClientImpl implements SearchApiClient {
	...
	return jsonArrayToStringArrayByField(valueObject, WebUserSetFields.ID);
    }
     ...
     * @throws JSONException
     */
    protected List<String> jsonArrayToStringArrayByField(JSONArray valueObject, String fieldName) throws JSONException {
	...
	try {
	    ...
	    JSONObject jo = new JSONObject(jsonResponse);
	    JSONArray itemsArray = jo.getJSONArray(WebUserSetFields.ITEMS);
	    return jsonArrayToStringArrayByField(itemsArray, WebUserSetFields.DC_DESCRIPTION);
