package eu.europeana.set.utils.parse;
...
//	InputStream testJsonStream = getClass().getResourceAsStream("/simpletest-001.jsonld");          
	protected static final ObjectMapper mapper = new ObjectMapper();           
//	JsonFactory factory = mapper.getFactory();          
//	JsonParser parser = factory.createParser(testJsonStream);           
//	SimpleTest simple = mapper.readValue(parser, SimpleTest.class);
	
//    protected static final JsonFactory jsonFactory = new JsonFactory();
    protected static final JsonFactory jsonFactory = mapper.getFactory();
