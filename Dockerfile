...
EXPOSE 8080
ENTRYPOINT ["java", "-cp", "/opt/app/:/opt/app/config/", "-jar", "/opt/app/set-web-executable.jar", "--spring.config.name=set.common,set.user" , "--spring.config.additional-location=file:/opt/app/config/set.user.properties"]