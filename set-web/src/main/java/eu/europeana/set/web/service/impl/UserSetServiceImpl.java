...
//			getMongoPersistence().
    ...
    public UserSet updateUserSetsWithCloseSetItems(UserSet storedUserSet, List<String> items) {    	
    	...
    	storedUserSet.setIsDefinedBy(null);
    	return storedUserSet;
    }
        
    /* (non-Javadoc)
     * @see eu.europeana.set.web.service.UserSetService#isOpenSet(eu.europeana.set.definitions.model.UserSet)
     */
