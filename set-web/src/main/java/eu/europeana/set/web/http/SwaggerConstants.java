...
public class SwaggerConstants {
    ...
    public static final String SEARCH           = "Searching user sets. The criteria for filtering results is provided in form of <field>:<value> pairs, using the query and qf request parameters. Currently supported fields are: type, visibility, creator, item, and provider.";
