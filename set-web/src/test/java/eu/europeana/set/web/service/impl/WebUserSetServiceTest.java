...
public class WebUserSetServiceTest {
  ...
  public void storeUserSetInDbRetrieveAndSerialize() throws IOException, HttpException {
    ...
    UserSet testUserSet = getObjectBuilder().buildUserSet(userSet,
        UserSetTestObjectBuilder.ITEMS_TEST_INPUT_FILE, true);
  ...
  public void deleteUserSet() throws HttpException, IOException {
    ...
    UserSetNotFoundException thrown = assertThrows(UserSetNotFoundException.class,
        () -> webUserSetService.getUserSetById(userId), "Must Throw UserSetNotFoundException");
  ...
  public void getUserSet() throws HttpException, IOException {
    ...
    // store user set in database
    UserSet storedUserSet = webUserSetService.storeUserSet(testUserSet, getAuthentication());
    UserSet stored1200UserSet =
        webUserSetService.storeUserSet(test1200UserSet, getAuthentication());
  ...
  public void insertItemUserSet() throws HttpException, IOException {
    ...
    // insert empty items
    UserSet dbUserSet =
        webUserSetService.insertItem(TEST_DATASET_ID, TEST_LOCAL_ID, TEST_POSITION, webUserSet);
    ...
    dbUserSet =
        webUserSetService.insertItem(TEST_DATASET_ID, TEST_LOCAL_ID_5, TEST_POSITION, webUserSet);
    ...
    dbUserSet = webUserSetService.insertItem(TEST_DATASET_ID, TEST_LOCAL_ID_7, TEST_POSITION_BIG,
        webUserSet);
  ...
  private Authentication getAuthentication() {
    return new EuropeanaAuthenticationToken(null, "usersets", "junit-test-user-id",
        new EuropeanaApiCredentials("junit-test-username"));
  }
